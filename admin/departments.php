                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <a href="new-department.php" type="button" class="btn btn-primary float-sm-right"><i class="fas fa-user-graduate"></i> Add New</a>
                                </div>
                            </div>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                           ...
                           <?php while($student_row = mysqli_fetch_array($students_result)): ?>
                            <tr>
                                ...
                                <td><a href="department-delete.php?id=<?php echo $student_row['department_id']; ?>"> Delete</a></td>
                            </tr>
                            <?php endwhile; ?>
                            </tbody>
                            <tfoot>
